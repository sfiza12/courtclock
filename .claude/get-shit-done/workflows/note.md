...
- **Global scope**: `C:/Users/Abhishek Shukla/Desktop/CourtClock/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Abhishek Shukla/Desktop/CourtClock/.claude/notes/`)
...
2. Glob `C:/Users/Abhishek Shukla/Desktop/CourtClock/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Abhishek Shukla/Desktop/CourtClock/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Abhishek Shukla/Desktop/CourtClock/.claude/notes/` — works in any directory
